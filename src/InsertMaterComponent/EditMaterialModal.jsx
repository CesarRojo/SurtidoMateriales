...
const EditMaterialModal = ({ isOpen, onClose, material, onUpdate, onDelete, fetchData }) => {
    ...
    const handleUpdate = async () => {
        ...
        if (confirmUpdate) {
            await axios.put(`http://172.30.189.112:5000/material/${material.idMaterial}`, updatedMaterial);
    ...
    const handleDelete = async () => {
        ...
        if (confirmDelete) {
            await axios.delete(`http://172.30.189.112:5000/material/${material.idMaterial}`);
