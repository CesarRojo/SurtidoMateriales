...
function InsertMaterComponent() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://172.30.189.112:5000/material`);
    ...
    const handleInsert = async (e) => {
        ...
        try {
            ...
            await axios.post(`http://172.30.189.112:5000/material`, newMaterial);
    ...
    const handleUpload = async () => {
        ...
        try {
            const res = await axios.post(`http://172.30.189.112:5000/material/bulk-update`, formData, {
                headers: {
